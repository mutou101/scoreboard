...
export default function Index () {
  ...
  return (
    <View className="web-view">
      <View className='at-article__h3'>常德市第一人民医院用户服务协议</View>
      <View className='at-article__content'>
        <View className='at-article__section'>
          <View className='at-article__p'>
            常德市第一人民医院智慧医疗平台是由常德市第人民医院提供医疗专家团队，依托互联网和微信/支付宝/小荷/抖音/头条以及广州海鹚网络科技有限公司建设与运营的智慧医疗平台(以下统称“本平台”)"用户“是指使用本平台服务的使用人，在本协议更多地称为“您"。
          </View>
          <View className='at-article__p'>
          ...
          <View className='at-article__p'>
            1.1 您使用本平台服务前应仔细阅读并透彻理解常德市第一人民医院智慧医疗用户协议及该协议项下所包含的其他附属协议、附加条款(以下简称“本协议”)，在确认充分理解并同意后方可使用本平台服务。
          </View>
          <View className='at-article__p'>
          ...
          <View className='at-article__p'>
            6.2 本平台深知个人信息安全的重要性，本平台将按照法律法规要求，采取安全保护措施，保护您的个人信息安全。具体详见《常德市第一人民医院小程序/公众号隐私政策》。
          </View>
